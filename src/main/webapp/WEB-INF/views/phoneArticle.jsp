      ...
      <a class="fbAdLink">
        ...
        <ul class="related_articles">
	        <c:forEach items="${sessionScope.relatedItem }"  var="item">
				...
				<a href="${ctx}/a/?uuid=${item.uuid}&category=${item.category}&keywords=${item.keyWords}" target="_blank">
			
				<span class="related_articles_img " style="background-image:url(${item.imgURL}), url(http://static.newsdog.today/images/related_article_default_img.png);">
				</span>
		
				<span class="related_articles_text">${item.title }</span>
				<span class="related_articles_tag"></span>
